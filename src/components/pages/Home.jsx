        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              ...
              alt="..."
            />
            <p class="carousel-text">CHECK OUT OUR NEW ARRIVALS</p>
          </div>
          <div class="carousel-item">
            <img
              ...
              alt="..."
            />
            <p class="carousel-text">WHERE WILL THIS SUMMER TAKE YOU?</p>
          </div>
          <div class="carousel-item">
            <img
              ...
              alt="..."
            />
            <p class="carousel-text">EXPLORE THE NEW COLLECTION</p>
          </div>
        </div>
        <button
